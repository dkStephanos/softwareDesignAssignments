...
//  This program's companion program is tcp variable message length client main.cpp
//----------------------------------------------------------------------------------------
...
#include "tcp_variable_message_length_server.h"     // tcp server socket class
#endif

#ifndef TCP_VARIABLE_LENGTH_MESSAGE_ROLLOVER_H
#include "tcp_variable_message_length_rollover.h"     // tcp server socket class
#endif
...
int main(void)
{
    ...
    const unsigned BUFFER_PAYLOAD_SIZE = 0;     // let buffer resize in response to I/O
    ...
    try
    {
        ...
        do
        {
            ...
            //
            tcp_variable_message_length_server_class server_socket;
            ...
            try
            {
                ...
                // ==== start listening for attempts to communicate ===
                //
                ...
                do
                {
                    ...
                    tcp_variable_message_length_rollover_class rollover_socket(BUFFER_PAYLOAD_SIZE);
