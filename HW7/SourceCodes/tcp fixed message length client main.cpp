...
//  This program's companion program is tcp fixed message length server main.cpp
//
//   Design notes:
...
#include "tcp_fixed_message_length_client.h"     // tcp server socket class
#endif
...
int main(void)
{
    ...
    try
    {
        ...
        do
        {
            ...
            //
            tcp_fixed_message_length_client_class client_socket(BUFFER_PAYLOAD_SIZE);
